...
```{r}
d.new <- prs_all.new(wt, 2, "lfenm", 0.3, 1, 1024)
d.sim <- prs_all.sim(wt, 2, "lfenm", 0.3, 1, 1024)


plot(d.sim$dfi$dr2i, d.new$dfi$dr2i)
plot(d.sim$dfi$dvsi, d.new$dfi$dvsi)
plot(d.sim$dfi$dvmi, d.new$dfi$dvmi)
