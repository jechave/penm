...
mb <- microbenchmark(get_mutants(wt, 1), delta_structure_mode(mutants_1),
                     get_mutants(wt, 5), delta_structure_mode(mutants_5),
                     get_mutants(wt, 10), delta_structure_mode(mutants_10),
                     fast_delta_structure_mode(wt),
                     times = 1)
...
dfnj_slow <- delta_structure_mode(mutants)

# Fast prs calculation (analytical)
dfnj_fast <- fast_delta_structure_mode(wt) %>% 
