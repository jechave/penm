...
#' @family enm mutating functions
#'
get_mutant_site_2 <- function(wt, site_mut, mutation = 0,
                              wt0 = wt, ideal = wt0,
                              sd_min = 2, dl_sigma = .3,
  ...
  if (update_enm) {
    ...
    # add/rm edges according to new xyz, keep lij for edges that don't change
  ...
  mut$energy <- energy(mut, ideal = ideal, sd_min = 2)
